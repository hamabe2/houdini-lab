...
- `screening.json`: 277 件 pending / published 2（`bendstiffness` /
  `bendrestscale`）/ screened 4
- **承認待ちが1件ある**: `benddampingratio`（採用 / 提案 0, 0.01, 0.1, 1 /
